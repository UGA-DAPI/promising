...
/// Group operation form *********************************************************
	...
	*/
    ...
    <?php
    	promising_print_projects($project, $currentGroupId, $cm->id);
		...
		echo "<a href='".rss_get_url($context->id, $USER->id, 'mod_promising',$project->projectgrpid)."'>".get_string('projectsrss','promising')."</a>";
		echo rss_get_link($context->id, $USER->id, 'mod_promising',$project->projectgrpid, get_string('projectsrss','promising'));
		echo "<br /><a href='view.php?expxml=1&amp;grpid=".$project->projectgrpid."'>".get_string('projectsexport','promising')."</a>";
