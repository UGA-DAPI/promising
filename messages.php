...
/// Group operation form *********************************************************
    ...
    <?php
    	promising_print_messages($project, $currentGroupId, $cm->id, 0 );
		$context = context_module::instance($cm->id);
        //if ($USER->editmode == 'on') {
        if (has_capability('mod/promising:adddiscussion', $context) && $project->etat==0) {
    		echo "<br/><a href='view.php?id={$cm->id}&amp;work=add&amp;parent=0'>".get_string('adddiscu','promising')."</a>&nbsp; ";
