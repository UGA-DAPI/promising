...
*/
function promising_compile_mail_template($template, $infomap, $module = 'promising') {
    $notification = implode('', promising_get_mail_template($template, $module));
...
*/
function promising_get_mail_template($virtual, $modulename, $lang = ''){
    global $CFG;
