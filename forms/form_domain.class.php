    ...
    */
    ...
    class Domain_Form extends moodleform {
    	...
    	function definition() {
        	...
        	$mform->addElement('html', $OUTPUT->heading(get_string('newvalueformfor', 'promising', get_string($this->domain, 'promising'))));
    		// Adding fieldset
    		$codeattributes = 'size="10" maxlength="10"';
    		$attributes = 'size="70" maxlength="128"';
    		$areaattributes = 'cols="30" rows="5"';

    		$mform->addElement('text', 'code', get_string('code', 'promising'), $codeattributes);
    		$mform->setDefault('code', $this->domainvalue->code);
    		$mform->addElement('text', 'label', get_string('label', 'promising'), $attributes);
