...
function toggle(i, n, ajax, wwwroot) {
	...
	if (e.style.display == 'none') {
		...
		document.images['img'+i].src = wwwroot + '/mod/promising/pix/p/switch_minus.gif';
    	if (ajax){
            var sUrl = wwwroot+'/mod/promising/ajax/updatecollapse.php?id='+moodlevars.cmid+'&entity='+moodlevars.view+'&userid='+moodlevars.userid+'&state=0&entryid='+i;
		...
		document.images['img' + i].src = wwwroot+'/mod/promising/pix/p/switch_plus.gif';
		if (ajax){
            var sUrl = wwwroot+'/mod/promising/ajax/updatecollapse.php?id='+moodlevars.cmid+'&entity='+moodlevars.view+'&userid='+moodlevars.userid+'&state=1&entryid='+i;
...
function toggle_show(i,n,wwwroot) {
	...
	if (e.style.display == 'none') {
		e.style.display = 'block';
		document.images['eye' + i].src = wwwroot+'/mod/promising/pix/p/show.gif';
	} else {
		e.style.display = 'none';
		document.images['eye' + i].src = wwwroot+'/mod/promising/pix/p/hide.gif';
	}
}