...
$string['intropromising'] = 'Description';
...
$string['promising:addinstance'] = 'Add a project';
$string['promising:beassignedtasks'] = 'Be assigned tasks';
$string['promising:canattachfiles'] = 'Can attach files';
$string['promising:canbeevaluated'] = 'Be evaluated';
$string['promising:changedelivs'] = 'Edit deliverables';
$string['promising:changemiles'] = 'Define milestones';
$string['promising:changenotownedtasks'] = 'Change not owned tasks (within group)';
$string['promising:changerequs'] = 'Edit specifications';
$string['promising:changespecs'] = 'Edit project requirements';
$string['promising:changetasks'] = 'Edit and change tasks';
$string['promising:gradeproject'] = 'Define assessment and evaluate the project';
$string['promising:manage'] = 'Manage the project environment';
$string['promising:configure'] = 'Configure the project environment';
$string['promising:managecriteria'] = 'Manage evaluation criteria';
$string['promising:manageremoterepository'] = 'Manage remote repository (CVS)';
$string['promising:managevalidations'] = 'Manage validation sessions';
$string['promising:posttodelivs'] = 'Post to deliverables';
$string['promising:validate'] = 'Validate';
$string['promising:viewpreproductionentities'] = 'View preproduction entities';
$string['promising:viewprojectcontrols'] = 'View project control screens';
$string['promising_help'] = 'project';
...
';
$string['modulename_help']=  ' Aide du module promising
';
$string['typeelm_help']=  ' 
...
"help.php?module=promising&amp;file=guestscanuse.html&amp;forcelang=fr_utf8"> </a>).</li>
...
"help.php?module=promising&amp;file=guestscanuse.html&amp;forcelang=fr_utf8">
</a>).</li>
